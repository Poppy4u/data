                        ...
                        <table style="overflow:scroll;" class="table table-striped table-hover animated fadeIn">
                            ...
                            <c:forEach var="student" items="${sessionScope.lookList}">
                                <tr>
                                    ...
                                    <td>
                                        <form id="form${student.sid}${cid}" action="/StudentInfo/TeacherHandler/addGrade" method="post">
                                            <input type="hidden" name="sid" value="${student.sid}">
                                            <input type="hidden" name="cid" value="${cid}">
                                            <input type="text" name="grade" value="">
<%--                                            <button value="添加" onclick="add('${cid}','${student.sid}')">添加</button>--%>
...
<script type="text/javascript">
    function add(cid, sid) {
        ...
        //     })
        // })
        console.log( $("#form" + sid + cid).serialize())
        console.log("#form" + sid + cid)
        $.ajax({
            type: "GET",
            url: '/StudentInfo/TeacherHandler/addGradeAjax?'+$("#form" + sid + cid).serialize(),
            dataType: "text",
            success: function (data) {
                alert("添加成功");
            },
